...
**Cover language = vacancy language. If Ukrainian JD → Ukrainian cover. If English JD → English cover.**
...
Most applicants are generic PMs. The HM's first screening question is: **"Is this person in the right category?"** The cover must answer that in the first sentence — before they decide to scroll past.

**Rule #1 — No specific experience in cover.**
The CV already contains all evidence. The cover must NOT repeat or reference specific company names, project names, roles, or metrics from the CV. That's what the CV is for. The cover creates the impulse to open it — the CV delivers the proof.
...
- **Greeting by company type** (from Phase 1 section 1.2):
  ...
  - `enterprise` / `scaleup` → `Dear Hiring Team,`
