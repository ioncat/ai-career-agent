...
**If found: add to ❌ (not ⚠️/🔧) and rewrite in plain, direct B2 vocabulary before output.** Found recurring across multiple CVs/covers (e.g. vacancy #1169) — treat as a hard gate, not a scan-and-hope pass.
